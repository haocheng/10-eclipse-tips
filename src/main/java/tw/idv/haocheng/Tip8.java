...
public class Tip8 {
	...
	// =================================================================== 
	// code below are copied from {java.util.Collections} for demo purpose
	// ===================================================================
	...
	static class UnmodifiableNavigableMap<K, V> extends
		...
		public Entry<K, V> lowerEntry(K key) {
			...
			return (null != lower) ? new UnmodifiableEntrySet.UnmodifiableEntry<>(
					lower) : null;
		}
		...
		public Entry<K, V> floorEntry(K key) {
			...
			return (null != floor) ? new UnmodifiableEntrySet.UnmodifiableEntry<>(
					floor) : null;
		}
		...
		public Entry<K, V> ceilingEntry(K key) {
			...
			return (null != ceiling) ? new UnmodifiableEntrySet.UnmodifiableEntry<>(
					ceiling) : null;
		}
		...
		public Entry<K, V> higherEntry(K key) {
			...
			return (null != higher) ? new UnmodifiableEntrySet.UnmodifiableEntry<>(
					higher) : null;
		}
		...
		public Entry<K, V> firstEntry() {
			...
			return (null != first) ? new UnmodifiableEntrySet.UnmodifiableEntry<>(
					first) : null;
		}
		...
		public Entry<K, V> lastEntry() {
			...
			return (null != last) ? new UnmodifiableEntrySet.UnmodifiableEntry<>(
					last) : null;
		}
	...
	static class CheckedNavigableSet<E> extends CheckedSortedSet<E> implements
		...
		public NavigableSet<E> subSet(E fromElement, E toElement) {
			return checkedNavigableSet(
					ns.subSet(fromElement, true, toElement, false), type);
		}
	...
	static class CheckedNavigableMap<K, V> extends CheckedSortedMap<K, V>
		...
		public Entry<K, V> lowerEntry(K key) {
			...
			return (null != lower) ? new CheckedMap.CheckedEntrySet.CheckedEntry<>(
					lower, valueType) : null;
		}
		...
		public Entry<K, V> floorEntry(K key) {
			...
			return (null != floor) ? new CheckedMap.CheckedEntrySet.CheckedEntry<>(
					floor, valueType) : null;
		}
		...
		public Entry<K, V> ceilingEntry(K key) {
			...
			return (null != ceiling) ? new CheckedMap.CheckedEntrySet.CheckedEntry<>(
					ceiling, valueType) : null;
		}
		...
		public Entry<K, V> higherEntry(K key) {
			...
			return (null != higher) ? new CheckedMap.CheckedEntrySet.CheckedEntry<>(
					higher, valueType) : null;
		}
		...
		public Entry<K, V> firstEntry() {
			...
			return (null != first) ? new CheckedMap.CheckedEntrySet.CheckedEntry<>(
					first, valueType) : null;
		}

		public Entry<K, V> lastEntry() {
			Entry<K, V> last = nm.lastEntry();
			return (null != last) ? new CheckedMap.CheckedEntrySet.CheckedEntry<>(
					last, valueType) : null;
		}
	 ...
	 * hasPrevious} always return {@code false}.</li>
